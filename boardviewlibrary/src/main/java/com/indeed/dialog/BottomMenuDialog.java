...
public class BottomMenuDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder addMenu(String text, int color,View.OnClickListener listener) {
            BottomMenu bm = new BottomMenu(text, color, listener);
            this.p.menuList.add(bm);
            return this;
        }

        public Builder addMenu(int textId, int color, View.OnClickListener listener) {
            return addMenu(p.context.getString(textId),color, listener);
        }
        ...
        public BottomMenuDialog create() {
            ...
            for (int i = 0; i < p.menuList.size(); i++) {
                ...
                bbm.setTextColor(bottomMenu.color);
                bbm.setTextSize(18);
    ...
    private static class BottomMenu {
        ...
        public int color = 0xFF007AFF;
        public View.OnClickListener listener;

        public BottomMenu(String funName,int color, View.OnClickListener listener) {
